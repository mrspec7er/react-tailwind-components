    ...
    <nav className="bg-white sticky top-0 border-secondary px-2 sm:px-4 py-2.5 rounded z-20">
      <div className="flex flex-wrap items-center justify-between mx-auto">
        ...
        <div
          ...
          id="mobile-menu-2"
        >
          <ul className="flex flex-col p-4 mt-4 border border-gray rounded-lg bg-gray md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white">
            <li>
              <Link
                to="/"
